...
import sty from "./PlasmicValue.module.css"; // plasmic-import: bCEAyhrvNVaR/css

import TakeOffIcon from "./icons/PlasmicIcon__TakeOff"; // plasmic-import: Wl8zJ4V0qQR0/icon
import CircleIcon from "./icons/PlasmicIcon__Circle"; // plasmic-import: RUFL4oY8TGPd/icon
import RightArrowIcon from "./icons/PlasmicIcon__RightArrow"; // plasmic-import: O-gEwGtHC5rO/icon
...
function PlasmicValue__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox___8OxYl, {
          [sty.freeBoxcenter___8OxYlYohHe]: hasVariant(
            $state,
            "center",
            "center"
          ),
          [sty.freeBoxtopBottom___8OxYlQPdS]: hasVariant(
            $state,
            "topBottom",
            "topBottom"
          )
      ...
      >
        <div className={classNames(projectcss.all, sty.freeBox__jekg0)}>
          {renderPlasmicSlot({
            defaultContents: (
              <TakeOffIcon
                className={classNames(projectcss.all, sty.svg__dic2C)}
                role={"img"}
              />
            ),
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__rFwmV, {
          [sty.freeBoxcenter__rFwmVYohHe]: hasVariant(
            $state,
            "center",
            "center"
          ),
          [sty.freeBoxwithButton__rFwmVyJnGh]: hasVariant(
            $state,
            "withButton",
            "withButton"
          )
      ...
      {(hasVariant($state, "withButton", "withButton") ? true : false) ? (
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__dSzYk, {
            [sty.freeBoxcenter__dSzYkYohHe]: hasVariant(
              $state,
              "center",
              "center"
            ),
            [sty.freeBoxwithButton__dSzYKyJnGh]: hasVariant(
              $state,
              "withButton",
              "withButton"
            )
