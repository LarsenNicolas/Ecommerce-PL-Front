...
import Label from "../../Label"; // plasmic-import: N5_52hT_2f73/component
import TextInput2 from "../../TextInput2"; // plasmic-import: h4D-Q_0GovDK/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: 6DAAjftXWvLO/component
import Description from "../../Description"; // plasmic-import: RS3bAwX7Nzay/component

import "@plasmicapp/react-web/lib/plasmic.css";

import projectcss from "./plasmic.module.css"; // plasmic-import: tFvQGwEHDigbr25c6CkR5z/projectcss
import sty from "./PlasmicTextField.module.css"; // plasmic-import: rqHy_S-mevTW/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__cts7W, {
          [sty.freeBoxiconEnd__cts7Wyf9Ep]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__cts7WFv1Qb]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__cts7WosHjm]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__rHaOz, {
            [sty.freeBoxiconStart__rHaOzFv1Qb]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__rHaOzosHjm]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg___0XDPj)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__ildA, {
            [sty.freeBoxiconEnd__ildAyf9Ep]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__ildAFv1Qb]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__ox6Cg)}
                role={"img"}
              />
            ),
